...
class WeightedGraph(object):
    """Implementation of a simple, directed, weighted graph."""
    def __init__(self):
    ...
    def add_edge(self, n1, n2, weight=0):
        ...
        self.graph[n1].update({n2: weight})
    ...
    def adjacent(self, n1, n2):
        ...
        return n2 in self.graph[n1].keys()
